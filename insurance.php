                    ...
                    <div class="text-center">
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <h1 class="hs-title-1 mb-0 golden-title"   data-i18n="Insurance" >
                ...
                <div class="container relative wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2" id="ifarb">
                            ...
                            <p  data-i18n="InsuranceB">
                                The commercial and industrial renaissance led to the growth and prosperity of the
                                insurance sector and increased the insurance awareness of all. Due to our theoretical
                                and practical experiences in this field, Saleh Al Saleh Advocates & Legal Consultants
                                provides its legal services to the insurance sector of the United Arab Emirates, both
                                for companies and individuals.
                            </p>
                            <p  data-i18n="InsuranceB1">
                                - Provide legal opinion and advice regarding insurance coverage for individuals and
                                companies of various kinds such as fire, loss of property, car accidents, professional
                                negligence, personal injury.
                            </p>

                            <p data-i18n="InsuranceB2">
                                - Representing clients in all issues related to insurance disputes
                            </p>
                            <p  data-i18n="InsuranceB3">
                                - Resolve insurance disputes and negotiate payment with insurance companies
                            </p>
