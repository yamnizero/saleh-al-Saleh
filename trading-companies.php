                    ...
                    <div class="text-center">
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <h1 class="hs-title-1 mb-0 golden-title" data-i18n="TradingCompanies"> 
                                    <span class="wow charsAnimIn" 
                                    data-splitting="chars">Trading companies
                            </div>
                            <!-- End Page Title -->
                ...
                <div class="container relative wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2" id="ifarb">
                            ...
                            <p data-i18n="TradingCompaniesB">
                                Al Saleh Al Saleh Lawyers and Legal Consultants Team is experienced and continuously
                                following up on all laws that determine the shape of the company and the procedures for
                                establishing each of them. Our lawyers and advisors can provide advice and guidance to
                                all investors .
                            </p>
