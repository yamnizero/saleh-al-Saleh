                    ...
                    <div class="text-center">
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <h1 class="hs-title-1 mb-0 golden-title" data-i18n="PenalCases">
                                    <span class="wow charsAnimIn" data-splitting="chars">Penal cases
                            </div>
                            <!-- End Page Title -->
                ...
                <div class="container relative wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2" id="ifarb">
                            ...
                            <p data-i18n="PenalCasesB">
                                Saleh Al Saleh Advocates and Legal Consultants works to represent clients in criminal
                                proceedings, whether irregularities, misdemeanors or felonies before the courts of first
                                instance, appeals and cassation, according to the types of such criminal courts between
                                passage, municipality, public prosecution and state security.
                            </p>
